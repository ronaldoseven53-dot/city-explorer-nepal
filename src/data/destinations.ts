...
export const destinations: Destination[] = [
  ...
  },
  {
    ...
    description:
      "A sacred cluster of glacial lakes at 4,380 m in Langtang National Park, Gosaikunda has been venerated by Hindu and Buddhist pilgrims for millennia — legend holds that Lord Shiva created the lakes by thrusting his trident into the mountain to quench his thirst after drinking poison. Each August, during the Janai Purnima festival, tens of thousands of pilgrims make the high-altitude journey to bathe in its ice-cold waters. For trekkers, Gosaikunda offers a stunning off-the-beaten-path route that connects to the Langtang Valley and the Helambu circuit, making it one of Nepal's most versatile multi-day adventures.",
    activities: [
