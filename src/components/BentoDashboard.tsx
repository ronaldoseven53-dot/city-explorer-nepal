  ...
  return (
    <div id="discover" className="relative min-h-screen">
      ...
      >
        ...
        {/* ── CELL 3: Season Stats ── */}
        <BentoCard className="min-h-[420px] flex flex-col justify-between p-8" hoverShadow={HOVER_SHADOW}>
          <div>
            <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-blue-600 dark:text-blue-400 mb-1">Right Now</p>
            <h2 className="text-base font-bold text-zinc-900 dark:text-white tracking-tight mb-6">Season Pulse</h2>
            ...
            {[
              ...
              <div key={bar.label} className="mb-5">
                <div className="flex justify-between text-xs mb-1.5">
                  <span className="text-zinc-600 dark:text-white/55 font-medium">{bar.label}</span>
                  <span className="text-zinc-900 dark:text-white font-bold">{bar.value}</span>
                </div>
                <div className="h-1.5 bg-black/[0.08] dark:bg-white/[0.10] rounded-full overflow-hidden">
                  <motion.div
          ...
          <div className="flex flex-col items-center mt-4">
            <svg viewBox="0 0 80 80" className="w-24 h-24">
              <circle cx="40" cy="40" r="32" fill="none" stroke={isDark ? "rgba(255,255,255,0.10)" : "rgba(0,0,0,0.09)"} strokeWidth="6" />
              <defs>
              ...
              />
              <text x="40" y="44" textAnchor="middle" fill="var(--fill-primary)" fontSize="14" fontWeight="bold">{sesonPct}%</text>
            </svg>
            <p className="text-zinc-500 dark:text-white/45 text-xs mt-2 text-center">destinations in peak season</p>
          </div>
        </BentoCard>

        {/* ── Experience categories ── */}
        <ExperienceCard group={categoryGroups[0]} hoverShadow={HOVER_SHADOW} />
        <ExperienceCard group={categoryGroups[1]} className="lg:col-span-2" hoverShadow={HOVER_SHADOW} />
        <ExperienceCard group={categoryGroups[2]} className="lg:col-span-2" hoverShadow={HOVER_SHADOW} />
        <ExperienceCard group={categoryGroups[3]} hoverShadow={HOVER_SHADOW} />
        <ExperienceCard group={categoryGroups[4]} hoverShadow={HOVER_SHADOW} />
        <ExperienceCard group={categoryGroups[5]} hoverShadow={HOVER_SHADOW} />
